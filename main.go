...
func init() {
	...
	utilruntime.Must(digitaloceanv1beta1.AddToScheme(scheme))
...
func main() {
	...
	flag.BoolVar(&leaderElect, "leader-elect", false, "Enable leader election for controller manager. Enabling this will ensure there is only one active controller manager.")
	opts := zap.Options{
		Development: true,
	}
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "5f62cd76.smirlwebs.com",
	})
	if err != nil {
